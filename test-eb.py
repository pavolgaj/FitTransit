...
limits={'A':[-0.3,-0.1],'tC':[t0+45-1/24,t0+45+1/24],'w':[1e-3,1e-1],'p0':[0.95,1.05],'p1':[0,1],'p2':[-2,0]}
steps={'A':1e-3,'tC':1e-5,'w':1e-5,'p0':1e-5,'p1':1e-3,'p2':1e-2}

tt0=t0+45
t=np.linspace(-0.3,0.3,100)+tt0

g=1+param['A']*np.exp(-(t-param['tC'])**2/param['w']**2)
l=1+param['A']*param['w']**2/((t-param['tC'])**2+param['w']**2)
