...
t0=2.4e6
P=15
param={'A':-0.2,'tC':t0+45,'C':-0.2,'K':0.1,'g':2.5,'w':0.05,'wG':0.05,'wL':0.02,'p0':1,'p1':0.1,'p2':0}
...
limits={'A':[-0.3,-0.1],'tC':[t0+45-1/24,t0+45+1/24],'C':[-1,0],'K':[0,1],'g':[1,3],'w':[1e-3,1e-1],'wG':[1e-3,1e-1],'wL':[1e-3,1e-1],'p0':[0.95,1.05],'p1':[0,1],'p2':[-2,0]}
steps={'A':1e-3,'tC':1e-5,'C':1e-3,'K':1e-3,'g':1e-3,'w':1e-4,'wG':1e-5,'wL':1e-5,'p0':1e-5,'p1':1e-3,'p2':1e-2}
...
tf.fit_params=['A','C','K','tC','w','g','p0']  #t0,P,Rp,a,i,e,w,c1,c2,p0,p1,p2
