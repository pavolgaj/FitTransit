...
t0=2.4e6
P=15
param={'A':-0.2,'tC':t0+45,'w':21,'wG':0.05,'wL':0.02,'p0':1,'p1':0.1,'p2':0}
...
limits={'A':[-0.3,-0.1],'tC':[t0+45-1/24,t0+45+1/24],'w':[15,25],'wG':[1e-3,1e-1],'wL':[1e-3,1e-1],'p0':[0.95,1.05],'p1':[0,1],'p2':[-2,0]}
steps={'A':1e-3,'tC':1e-5,'w':1e-2,'wG':1e-5,'wL':1e-5,'p0':1e-5,'p1':1e-3,'p2':1e-2}
